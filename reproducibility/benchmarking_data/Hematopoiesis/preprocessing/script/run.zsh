...
trim_galore --suppress_warn --no_report_file -q 30 --paired -o ./ $1_1.fastq $1_2.fastq
rm $1_1.fastq &&
rm $1_2.fastq &&

# Map the reads to reference genome
bowtie2 --very-sensitive --no-discordant -x $3 -1 $1_1_val_1.fq -2 $1_2_val_2.fq -S $1.map.sam -X 2000 -p 100 &&
rm $1_1_val_1.fq &&
rm $1_2_val_2.fq &&
