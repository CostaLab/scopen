...
output_file = "/hpcwork/izkf/projects/SingleCellOpenChromatin/local/ATAC/Cell2018/Imputation/cisTopic/cisTopic.txt"
job_name = "cisTopic"
command = "sbatch -J " + job_name + " -o " + "./cluster_out/" + job_name + "_out.txt -e " + "./cluster_err/" + job_name + "_err.txt "
command += "-t 30:00:00 --mem 180G -c 48 -A rwth0233 ./run.zsh "
