...
### Job name
#SBATCH -J tagcount
#SBATCH --mail-user=lzj1769@gmail.com
...
input_dir=/hpcwork/izkf/projects/SingleCellOpenChromatin/local/ATAC/Nature2015/Merged
output_dir=/hpcwork/izkf/projects/SingleCellOpenChromatin/local/ATAC/Nature2015/TagCount

python get_tc.py $input_dir/ATACPeaks.merge.500.filter.bed $input_dir/ATAC.bam $output_dir/TagCount.txt None