...
#cd /hpcwork/izkf/projects/SingleCellOpenChromatin/data/ATAC/Cell2018/Merged
#samtools merge ATAC.bam /hpcwork/izkf/projects/SingleCellOpenChromatin/data/ATAC/Cell2018/Runs/*/*.bam
